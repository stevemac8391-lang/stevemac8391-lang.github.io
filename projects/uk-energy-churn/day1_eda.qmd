...
ggsave("plots/churn_geography.png", width = 6, height = 4, dpi = 300)
```
...
ggplot(churn, aes(x = Tenure, fill = factor(Exited))) +
  ...
  theme_minimal(base_size = 14)
ggsave("plots/churn_tenure.png", width = 6, height = 4, dpi = 300)
```
...
ggplot(churn, aes(x = Gender, fill = factor(Exited))) +
  ...
  theme_minimal(base_size = 14)
ggsave("plots/churn_gender.png", width = 6, height = 4, dpi = 300)
...
ggplot(churn, aes(x = NumOfProducts, fill = factor(Exited))) +
  ...
  theme_minimal(base_size = 14)
ggsave("plots/churn_no_of_products_owned.png", width = 6, height = 4, dpi = 300)
...
ggplot(churn, aes(x = IsActiveMember, fill = factor(Exited))) +
  ...
  theme_minimal(base_size = 14)
ggsave("plots/churn_engagement.png", width = 6, height = 4, dpi = 300)
...
ggplot(churn, aes(x = Age, fill = factor(Exited))) +
  ...
  theme_minimal(base_size = 14)
ggsave("plots/churn_age.png", width = 6, height = 4, dpi = 300)
...
ggplot(churn_df, aes(x = credit_bin, fill = factor(Exited))) +
  ...
  theme_minimal(base_size = 14)
ggsave("plots/churn_credit_score.png", width = 6, height = 4, dpi = 300)
```
...
ggplot(churn_df, aes(x = salary_bin, fill = factor(Exited))) +
  ...
  theme_minimal(base_size = 14)
ggsave("plots/churn_salary_range.png", width = 6, height = 4, dpi = 300)
```
...
corrplot(num_vars, 
         ...
         mar = c(0,0,2,0))
ggsave("plots/churn_correlation_heatmap.png", width = 6, height = 4, dpi = 300)
```
